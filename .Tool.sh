...
cd $HOME
echo "Wait....."
wget https://raw.githubusercontent.com/rooted-cyber/Termux-Tool/master/update.txt > /dev/null 2>&1
echo
clear
echo -e "\033[92m"
cat update.txt
rm -f update.txt
echo " [-] Current Version : V3.4"
echo
echo -e "\033[93m [ 1 ]\033[96m Update Termux-Tool"
...
printf "\e[0m"
printf "\e[1;96m\n===============================================\n\e[96m"
printf "\e[1;96m 	[~] Termux-Tool V3.2		\e[0m\n"
printf "\e[1;96m===============================================\n\e[0m"
echo
printf "\033[1;92m"
printf "\e[91m[ 1 ]\033[92m Open Your Termux	\e[91m[ 2 ]\e[93m Tools\n"
printf "\e[91m[ 3 ]\033[92m Termux-Common	\033[91m[ 4 ]\033[93m Boot in Start\n"
...
echo
toilet -F gay -f term ==============================================
printf "\033[95m	[ T ] Termux-Tool Uninstalled\033[0m\n"
toilet -F gay -f term ==============================================
echo
printf "\e[1;96m\n===============================================\e[96m"
printf "\e[1;96m\n	[ U ] Update Termux-Tool \e[0m"
printf "\e[1;96m\n===============================================\e[0m"
printf "\e[92m\n\n"
